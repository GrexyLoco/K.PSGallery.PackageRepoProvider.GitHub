...
function Invoke-Import {
    ...
    try {
        Write-LogInfo "Importing module: $($ModuleName ?? $ModulePath)"
        ...
        Write-LogInfo "Successfully imported module"
        ...
        Write-LogError "Failed to import module: $($_.Exception.Message)"
        throw
    }
}
